...
/**
 * Class for lightly active minutes
 */
@JsonIgnoreProperties(ignoreUnknown = true)
public class LightlyActiveMinute extends ATimeValue {	
	/* ==============================================================
	 * instance fields
	 * ============================================================== */
	/** active minute value */
	 ...
	 */
	@JsonCreator
	protected LightlyActiveMinute(@JsonProperty("dateTime") String dateTime,
